...
// 	protoc        v3.11.4
// source: github.com/joshuakb2/buildkit/api/types/worker.proto
...
func (x *WorkerRecord) Reset() {
	*x = WorkerRecord{}
	mi := &file_github_com_joshuakb2_buildkit_api_types_worker_proto_msgTypes[0]
...
func (*WorkerRecord) Descriptor() ([]byte, []int) {
	return file_github_com_joshuakb2_buildkit_api_types_worker_proto_rawDescGZIP(), []int{0}
}
...
func (x *GCPolicy) Reset() {
	*x = GCPolicy{}
	mi := &file_github_com_joshuakb2_buildkit_api_types_worker_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GCPolicy) Descriptor() ([]byte, []int) {
	return file_github_com_joshuakb2_buildkit_api_types_worker_proto_rawDescGZIP(), []int{1}
}
...
func (x *BuildkitVersion) Reset() {
	*x = BuildkitVersion{}
	mi := &file_github_com_joshuakb2_buildkit_api_types_worker_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BuildkitVersion) Descriptor() ([]byte, []int) {
	return file_github_com_joshuakb2_buildkit_api_types_worker_proto_rawDescGZIP(), []int{2}
}
...
func (x *CDIDevice) Reset() {
	*x = CDIDevice{}
	mi := &file_github_com_joshuakb2_buildkit_api_types_worker_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CDIDevice) Descriptor() ([]byte, []int) {
	return file_github_com_joshuakb2_buildkit_api_types_worker_proto_rawDescGZIP(), []int{3}
}
...
var File_github_com_joshuakb2_buildkit_api_types_worker_proto protoreflect.FileDescriptor

const file_github_com_joshuakb2_buildkit_api_types_worker_proto_rawDesc = "" +
	"\n" +
	"4github.com/joshuakb2/buildkit/api/types/worker.proto\x12\x16moby.buildkit.v1.types\x1a1github.com/joshuakb2/buildkit/solver/pb/ops.proto\"\xa3\x03\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B@Z>github.com/joshuakb2/buildkit/api/types;moby_buildkit_v1_typesb\x06proto3"

var (
	file_github_com_joshuakb2_buildkit_api_types_worker_proto_rawDescOnce sync.Once
	file_github_com_joshuakb2_buildkit_api_types_worker_proto_rawDescData []byte
)

func file_github_com_joshuakb2_buildkit_api_types_worker_proto_rawDescGZIP() []byte {
	file_github_com_joshuakb2_buildkit_api_types_worker_proto_rawDescOnce.Do(func() {
		file_github_com_joshuakb2_buildkit_api_types_worker_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_joshuakb2_buildkit_api_types_worker_proto_rawDesc), len(file_github_com_joshuakb2_buildkit_api_types_worker_proto_rawDesc)))
	})
	return file_github_com_joshuakb2_buildkit_api_types_worker_proto_rawDescData
}

var file_github_com_joshuakb2_buildkit_api_types_worker_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_github_com_joshuakb2_buildkit_api_types_worker_proto_goTypes = []any{
...
var file_github_com_joshuakb2_buildkit_api_types_worker_proto_depIdxs = []int32{
...
func init() { file_github_com_joshuakb2_buildkit_api_types_worker_proto_init() }
func file_github_com_joshuakb2_buildkit_api_types_worker_proto_init() {
	if File_github_com_joshuakb2_buildkit_api_types_worker_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_joshuakb2_buildkit_api_types_worker_proto_rawDesc), len(file_github_com_joshuakb2_buildkit_api_types_worker_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_github_com_joshuakb2_buildkit_api_types_worker_proto_goTypes,
		DependencyIndexes: file_github_com_joshuakb2_buildkit_api_types_worker_proto_depIdxs,
		MessageInfos:      file_github_com_joshuakb2_buildkit_api_types_worker_proto_msgTypes,
	}.Build()
	File_github_com_joshuakb2_buildkit_api_types_worker_proto = out.File
	file_github_com_joshuakb2_buildkit_api_types_worker_proto_goTypes = nil
	file_github_com_joshuakb2_buildkit_api_types_worker_proto_depIdxs = nil
}
