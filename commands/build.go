...
import (
	...
	"github.com/joshuakb2/buildx/util/tracing"
	...
	"github.com/joshuakb2/buildkit/frontend/subrequests"
	...
	"github.com/joshuakb2/buildkit/session/auth/authprovider"
	"github.com/joshuakb2/buildkit/solver/errdefs"
	solverpb "github.com/joshuakb2/buildkit/solver/pb"
	sourcepolicy "github.com/joshuakb2/buildkit/sourcepolicy/pb"
...
func decodeExporterResponse(exporterResponse map[string]string) map[string]any {
	decFunc := func(k, v string) ([]byte, error) {
		if k == "result.json" {
			...
			// is already a JSON object: https://github.com/joshuakb2/buildkit/blob/f6eb72f2f5db07ddab89ac5e2bd3939a6444f4be/frontend/dockerui/requests.go#L100-L102
			return []byte(v), nil
		}
